...
public class ModTileEntityTypes{
    ...
    public static final RegistryObject<TileEntityType<ExampleTile>> EXAMPLE_TILE = TILE_ENTITY_TYPES.register("example_tile", () -> TileEntityType.Builder.create(ExampleTile::new, BlockInit.example_tile).build(null));
}

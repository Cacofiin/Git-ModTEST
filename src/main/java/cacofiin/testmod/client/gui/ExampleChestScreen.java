package cacofiin.testmod.client.gui;
...
public class ExampleChestScreen extends ContainerScreen<ExampleChestContainer> {
    ...
    private static final ResourceLocation BACKGROUND_TEXTURE = new ResourceLocation(TestMod.MOD_ID, "textures/gui/example_chest.png");
